...
CREATE TABLE `easipay_trxlog` (
  ...
  `msg_type` char(2) NOT NULL COMMENT '报文类型[00:请求 01:响应 03:tower请求]',
  PRIMARY KEY (`id`),
...
CREATE TABLE `pf_puchaseforeign_detail` (
  ...
  `tower_amt` bigint(20) DEFAULT NULL COMMENT 'tower代扣金额',
  `custid` varchar(32) DEFAULT NULL COMMENT '用户id',
...
CREATE TABLE `pf_puchaseforeign_info` (
  ...
  `tower_amt` int(11) DEFAULT NULL COMMENT 'tower代扣金额',
...
CREATE TABLE `rf_pay_application` (
  ...
  `rf_amt` int(11) DEFAULT NULL COMMENT 'tower代扣金额',
